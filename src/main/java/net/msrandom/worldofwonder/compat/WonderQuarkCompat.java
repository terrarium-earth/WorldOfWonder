...
public class WonderQuarkCompat {
    ...
    public static final Block STEM_CHEST_BLOCK = WonderBlocks.add("stem_chest", new StemChestBlock(), WonderClientHandler.getWithRenderer(new Item.Properties().group(ItemGroup.DECORATIONS), () -> () -> new WonderItemRenderer(WonderQuarkCompat.STEM_CHEST_ENTITY)));
    public static final Block STEM_TRAPPED_CHEST_BLOCK = WonderBlocks.add("stem_trapped_chest", new StemTrappedChestBlock(), WonderClientHandler.getWithRenderer(new Item.Properties().group(ItemGroup.REDSTONE), () -> () -> new WonderItemRenderer(WonderQuarkCompat.STEM_TRAPPED_CHEST_ENTITY)));
