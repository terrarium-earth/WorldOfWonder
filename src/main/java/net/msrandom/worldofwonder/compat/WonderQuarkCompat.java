...
public class WonderQuarkCompat {
    ...
    public static final RegistryObject<Block> STEM_CHEST_BLOCK = add("stem_chest", StemChestBlock::new, WonderClientHandler.getWithRenderer(new Item.Properties().tab(ItemGroup.TAB_DECORATIONS), () -> () -> new WonderItemRenderer(WonderQuarkCompat.STEM_CHEST_ENTITY.get())));
    public static final RegistryObject<Block> STEM_TRAPPED_CHEST_BLOCK = add("stem_trapped_chest", StemTrappedChestBlock::new, WonderClientHandler.getWithRenderer(new Item.Properties().tab(ItemGroup.TAB_REDSTONE), () -> () -> new WonderItemRenderer(WonderQuarkCompat.STEM_TRAPPED_CHEST_ENTITY.get())));
    ...
    public static <T extends Block> RegistryObject<T> add(String name, Supplier<T> block, Item.Properties properties) {
        ...
        WonderItems.REGISTRY.register(name, () -> new BlockItem(registryObject.get(), properties));
