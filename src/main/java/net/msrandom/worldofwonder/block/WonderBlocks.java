...
public class WonderBlocks {
    ...
    public static final Block STEM_SIGN = add("stem_sign", new StemStandingSignBlock(), new Item.Properties().maxStackSize(16).group(ItemGroup.DECORATIONS), (block, properties) -> new StemSignItem(properties, block, WonderBlocks.STEM_WALL_SIGN));
