...
public class DandelionHatModel extends BipedModel<LivingEntity> {
    ...
    public DandelionHatModel() {
        ...
        this.fluff7 = new ModelRenderer(this, 64, 35);
        this.fluff7.setRotationPoint(-3.0F, -8.5F, -3.0F);
        this.fluff7.func_228301_a_(-4.5F, 0.0F, -10.0F, 9, 0, 10, 0.0F);
        this.setRotateAngle(fluff7, -0.4363323129985824F, 0.7853981633974483F, 0.0F);
        this.fluff8 = new ModelRenderer(this, 64, 47);
        this.fluff8.setRotationPoint(3.0F, -8.5F, -3.0F);
        this.fluff8.func_228301_a_(-4.5F, 0.0F, -10.0F, 9, 0, 10, 0.0F);
        ...
        this.hat = new ModelRenderer(this, 94, 0);
        this.hat.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.hat.func_228301_a_(-5.0F, -9.5F, -5.0F, 10, 4, 10, 0.0F);
        this.fluff4 = new ModelRenderer(this, 64, 24);
        this.fluff4.mirror = true;
        this.fluff4.setRotationPoint(5.0F, -8.5F, 0.0F);
        this.fluff4.func_228301_a_(0.0F, 0.0F, -4.5F, 10, 0, 9, 0.0F);
        ...
        this.fluff1 = new ModelRenderer(this, 64, 0);
        this.fluff1.setRotationPoint(0.0F, -8.5F, 5.0F);
        this.fluff1.func_228301_a_(-4.5F, 0.0F, 0.0F, 9, 0, 10, 0.0F);
        this.setRotateAngle(fluff1, 0.4363323129985824F, 0.0F, 0.0F);
        this.fluff3 = new ModelRenderer(this, 64, 12);
        this.fluff3.setRotationPoint(0.0F, -8.5F, -5.0F);
        this.fluff3.func_228301_a_(-4.5F, 0.0F, -10.0F, 9, 0, 10, 0.0F);
        this.setRotateAngle(fluff3, -0.4363323129985824F, 0.0F, 0.0F);
        this.fluff2 = new ModelRenderer(this, 64, 24);
        this.fluff2.setRotationPoint(-5.0F, -8.5F, 0.0F);
        this.fluff2.func_228301_a_(-10.0F, 0.0F, -4.5F, 10, 0, 9, 0.0F);
        ...
        this.fluff5 = new ModelRenderer(this, 84, 47);
        this.fluff5.setRotationPoint(3.0F, -8.5F, 3.0F);
        this.fluff5.func_228301_a_(-4.5F, 0.0F, 0.0F, 9, 0, 10, 0.0F);
        this.setRotateAngle(fluff5, 0.4363323129985824F, 0.7853981633974483F, 0.0F);
        this.fluff6 = new ModelRenderer(this, 84, 35);
        this.fluff6.setRotationPoint(-3.0F, -8.5F, 3.0F);
        this.fluff6.func_228301_a_(-4.5F, 0.0F, 0.0F, 9, 0, 10, 0.0F);
