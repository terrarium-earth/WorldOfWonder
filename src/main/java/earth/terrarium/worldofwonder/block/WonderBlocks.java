...
public class WonderBlocks {
    ...
    public static final RegistryObject<Block> DANDELION_FLUFF = add("dandelion_fluff", () -> new DandelionFluffBlock(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS));
    ...
    public static final RegistryObject<Block> STEM_SIGN = add("stem_sign", StemStandingSignBlock::new, new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), StemSignItem::new);
