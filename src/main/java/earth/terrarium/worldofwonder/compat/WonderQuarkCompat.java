...
public class WonderQuarkCompat {
    ...
    public static final RegistryObject<Block> STEM_LADDER = add("stem_ladder", () -> new LadderBlock(Block.Properties.of(Material.DECORATION).strength(0.4F).noOcclusion().sound(SoundType.LADDER)), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS));
    public static final RegistryObject<Block> STEM_BOOKSHELF = add("stem_bookshelf", () -> new WonderBookshelfBlock(Block.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS));
    public static final RegistryObject<Block> STEM_VERTICAL_SLAB = add("stem_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)), new Item.Properties().tab(CreativeModeTab.TAB_BUILDING_BLOCKS));

    public static final RegistryObject<Block> STEM_CHEST_BLOCK = add("stem_chest", StemChestBlock::new, WonderClientHandler.getWithRenderer(new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS), () -> () -> new WonderItemRenderer(WonderQuarkCompat.STEM_CHEST_ENTITY)));
    public static final RegistryObject<Block> STEM_TRAPPED_CHEST_BLOCK = add("stem_trapped_chest", StemTrappedChestBlock::new, WonderClientHandler.getWithRenderer(new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE), () -> () -> new WonderItemRenderer(WonderQuarkCompat.STEM_TRAPPED_CHEST_ENTITY)));
